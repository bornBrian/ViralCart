...
export default function BannerSlider({ banners, onSearch }: BannerSliderProps) {
  ...
  return (
    <div className="relative bg-white">
      {/* Banner Slider */}
      <div
        className="relative w-full h-[200px] sm:h-[240px] md:h-[280px] overflow-hidden bg-gray-100"
          ...
          <div className="max-w-7xl mx-auto">
            <form onSubmit={handleSearchSubmit} className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 pl-10 pr-4 rounded-lg text-sm bg-white/95 backdrop-blur-sm border border-white/20 shadow-lg focus:outline-none focus:ring-2 focus:ring-white/50 focus:bg-white"
              />
              <svg
              ...
              {showSuggestions && suggestions.length > 0 && (
                <div className="absolute w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl max-h-64 overflow-y-auto">
              ...
              {showSuggestions &&
                ...
                suggestions.length === 0 && (
                  <div className="absolute w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl px-4 py-3">
